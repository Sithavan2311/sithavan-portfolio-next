      ...
      <div className="mx-auto mt-12 grid max-w-5xl gap-8 md:grid-cols-2">
        <TiltCard intensity={5}>
          <div className="h-full rounded-3xl bg-zinc-900/70 p-8 shadow-lg shadow-red-950/20 ring-1 ring-red-900/40 backdrop-blur-sm">
            ...
            <div className="mt-6 rounded-xl bg-red-950/50 p-4 ring-1 ring-red-900/50">
              <p className="text-sm text-red-300">
                ⚡ <strong>Currently available</strong> for Java backend &amp; full-stack developer opportunities.
              </p>
            </div>
          </div>
        </TiltCard>
